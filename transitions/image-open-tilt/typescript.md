# Image open tilt — TypeScript (Pro)
...
function makeBendEase(raw: string) {
...
function grid(g: Float32Array, x: number, y: number): number {
...
function noise(g: Float32Array, px: number, py: number): number {
...
export function ImageOpenTilt({ src, alt = "" }: { src: string; alt?: string }) {
